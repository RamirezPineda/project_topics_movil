...
export "show_message_utils.dart";

Future<dynamic> messageSimple(BuildContext context, String message) {
  return showDialog(
    context: context,
...
Future<dynamic> showDeleteMessage(BuildContext context, String id) {
